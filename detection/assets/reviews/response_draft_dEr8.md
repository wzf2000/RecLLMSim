...
If the additional replay validation study is completed within the revision window, we will also report a human-reference agreement estimate on a stratified subset of counterfactual candidate responses.
...
These results show that user rating-style priors explain a large fraction of full-score correlation.
